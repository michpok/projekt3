...
kontrola_vstupu('https://volby.cz/', vstup[0], 'spatny vstupni hodnoty')
...
while index < len(webcisla):
    ...
    for cislo in finalInformace:
        extraxeCislaFinal = vrat_cislo(cislo)
        finalzpracovani.append(extraxeCislaFinal)
